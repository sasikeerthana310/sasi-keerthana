...
resetbtn = Button(top, text = "   Reset   ",command =clear,font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white" ).place(x = 50, y = 600)
sbmitbtn = Button(top, text = " Continue ",command = box,font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white").place(x = 600, y = 600)
