...
class Database:
    ...
    def Insert(self,accountno,holdername,dob,phone,ifsccode,depositamount,withdrawalamount,balance,):
        self.dbCursor.execute("INSERT INTO user_info VALUES (?, ?, ?, ?, ?, ?, ?, ?)",(accountno,holdername,dob,phone,ifsccode,depositamount,withdrawalamount,balance,),)
    ...
    def Delete(self, accountno):
        self.dbCursor.execute("DELETE FROM user_info WHERE accountno = ?", (accountno,))
        self.dbConnection.commit()

    def Display(self):
        self.dbCursor.execute("SELECT * FROM user_info")
...
class InsertWindow:
    def __init__(self):
        ...
        tkinter.Label(self.window, text="Phone Number", width=25).grid(pady=5, column=1, row=4)
        ...
        # Fields
        # Entry widgets
        self.accountnoEntry = tkinter.Entry(self.window, width=25, textvariable=self.accountno)
        ...
        self.accountnoEntry.grid(pady=5, column=3, row=1)
        ...
        # Button widgets
        tkinter.Button(self.window, width=20, text="Insert", command=self.Insert,font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white").grid(pady=15, padx=5, column=1, row=14)
    ...
    def Insert(self):
        ...
        self.test = self.values.Validate(self.accountnoEntry.get(),self.holdernameEntry.get(),self.dobEntry.get(),self.phoneEntry.get(),self.ifsccodeEntry.get(),self.depositamountEntry.get(),self.withdrawalamountEntry.get(),self.balanceEntry.get(),)
        if self.test == "SUCCESS":
            self.database.Insert(self.accountnoEntry.get(),self.holdernameEntry.get(),self.dobEntry.get(),self.phoneEntry.get(),self.ifsccodeEntry.get(),self.depositamountEntry.get(),self.withdrawalamountEntry.get(),self.balanceEntry.get(),)
...
class HomePage:
    def __init__(self):
        ...
        tkinter.Button(self.homePageWindow, width=20, text="Insert", command=self.Insert, font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white").grid(pady=15, column=1, row=2)
        tkinter.Button(self.homePageWindow, width=20, text="Update", command=self.Update, font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white").grid(pady=15, column=1, row=3)
        tkinter.Button(self.homePageWindow, width=20, text="Search", command=self.Search, font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white").grid(pady=15, column=1, row=4)
        tkinter.Button(self.homePageWindow, width=20, text="Delete", command=self.Delete, font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white").grid(pady=15, column=1, row=5)
        tkinter.Button(self.homePageWindow, width=20, text="Display", command=self.Display, font='HarlowSolidItalic 14 bold italic',background = "dark blue",foreground="white").grid(pady=15, column=1, row=6)
